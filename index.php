...
// Agrega credenciales
MercadoPago\SDK::setAccessToken('TEST-6131617795804756-101621-8c95d41fe3864338d46bde590b70eb5d-103005416');
?>
<?php
// SDK de Mercado Pago
require __DIR__ .  '/vendor/autoload.php';
                        ...
                        <div class="pd-billboard pd-category-header">
                            <div class="pd-l-plate-scale">
                                ...
                                <div class="pd-billboard-info">
                                    <h1 class="pd-billboard-header pd-util-compact-small-18">Tiendaa e-commerce</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            ...
                                            <button type="submit" class="mercadopago-button" formmethod="post"><form action="/procesar-pago" method="POST">
  <script
